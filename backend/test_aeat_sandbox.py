"""
AEAT Sandbox Test Script - With Chain Management
Tests certificate, connection, and invoice submission with proper hash chaining.

Usage:
    python test_aeat_sandbox.py /path/to/certificate.p12 your_password

Or set environment variables:
    export AEAT_CERT_PATH=/path/to/certificate.p12
    export AEAT_CERT_PASSWORD=your_password
    python test_aeat_sandbox.py
"""
